...
import (
	...
	appclient "github.com/servprotocolorg/serv/v12/client"
	"github.com/servprotocolorg/serv/v12/client/debug"
	"github.com/servprotocolorg/serv/v12/encoding"
	"github.com/servprotocolorg/serv/v12/ethereum/eip712"
	appserver "github.com/servprotocolorg/serv/v12/server"
	servercfg "github.com/servprotocolorg/serv/v12/server/config"
...
func (a appCreator) appExport(
	...
	if height != -1 {
		app = chainapp.NewServ(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := app.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		app = chainapp.NewServ(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}
