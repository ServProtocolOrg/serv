...
func EnableObservability() error {
	...
	// Please see https://github.com/evmos/evmos/issues/84
	// return nil
	// }

	//pe, err := prometheus.NewExporter(prometheus.Options{
	//	Namespace: constants.ApplicationBinaryName,
	//})
	//if err != nil {
	...
	// // TODO: Derive the Prometheus observability exporter from the Serv config.
	// addr := ":8877"
	// go func() {
