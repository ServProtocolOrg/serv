...
func (suite *KeeperTestSuite) TestDelegationAutoWithdrawAndDelegateMore() {
	...
	validator, _ = validator.AddTokensFromDel(sdk.TokensFromConsensusPower(1, evertypes.PowerReduction))
	delAmount := sdk.TokensFromConsensusPower(1, evertypes.PowerReduction)
