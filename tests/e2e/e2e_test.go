...
// TestCLITxs executes different types of transactions against a node of our chain
	...
	}{
		{
			...
			cmd: func() (string, error) {
				return s.upgradeManager.CreateSubmitProposalExec(
					...
					5000,
					true,
					"--fees=5000000000"+constants.BaseDenom,
					"--gas-prices=50000"+constants.BaseDenom,
				)
			},
			expPass:   false,
		...
		},
		{
			...
			cmd: func() (string, error) {
				return s.upgradeManager.CreateSubmitProposalExec(
					...
					5000,
					true,
					"--fees=500000000000"+constants.BaseDenom,
					"--gas=1000",
				)
			},
			expPass:   false,
		...
		},
		{
			...
			cmd: func() (string, error) {
				return s.upgradeManager.CreateSubmitProposalExec(
					...
					5000,
					true,
					"--fees=10000000000000000"+constants.BaseDenom,
					"--gas=1500000",
				)
			},
			expPass: true,
		},
		{
			...
			cmd: func() (string, error) {
				return s.upgradeManager.CreateSubmitProposalExec(
					...
					5000,
					true,
					"--gas-prices=1000000000"+constants.BaseDenom,
					"--gas=1500000",
				)
			},
			expPass: true,
