...
// TestVersionsLess tests the ServVersion type's Less method with
// different version strings
func TestVersionsLess(t *testing.T) {
	var version ServVersion
...
// TestVersionsSwap tests the ServVersion type's Swap method
...
// TestVersionsLen tests the ServVersion type's Len method
func TestVersionsLen(t *testing.T) {
	var version ServVersion = []string{"v9.1.0", "v10.0.0"}
