	...
	testcases := []struct {
		...
		},
		{
			...
			want: Params{
				...
				Versions: []VersionConfig{
					{"v0.1.0", "v0.1.0", dockerRepo},
					{"v0.2.0", "v0.2.0", dockerRepo},
					{latestVersionName, LocalVersionTag, dockerRepo},
				},
		...
		},
		{
			...
			want: Params{
				MountPath: defaultMountPath,
				Versions: []VersionConfig{
					{"v0.1.0-rc1", "v0.1.0-rc1", dockerRepo},
					{"v0.2.0-rc2", "v0.2.0-rc2", dockerRepo},
				},
				ChainID:     defaultChainID,
				WorkDirRoot: wd,
			},
		...
		},
		{
			...
			want: Params{
				MountPath: defaultMountPath,
				Versions: []VersionConfig{
					{defaultInitialVersion, defaultInitialVersion, dockerRepo},
					{latestVersionName, LocalVersionTag, dockerRepo},
				},
				ChainID:     defaultChainID,
				WorkDirRoot: wd,
