...
import (
	...
	"github.com/servprotocolorg/serv/v12/wallets/usbwallet"
)
...
func ServLedgerDerivation() Secp256k1DerivationFn {
	...
	return func() (sdkledger.SECP256K1, error) {
		return SECP256K1.connectToLedgerApp()
	}
}
...
// GetAddressPubKeySECP256K1 takes in the HD path as well as a "Human Readable Prefix" (hrp)
