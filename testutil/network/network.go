...
func DefaultConfig() Config {
	...
	return Config{
		...
		AccountTokens:     sdk.TokensFromConsensusPower(1000000000000000000, evertypes.PowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(500000000000000000, evertypes.PowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(100000000000000000, evertypes.PowerReduction),
...
// NewAppConstructor returns a new Serv AppConstructor
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	if !evertypes.IsValidChainID(cfg.ChainID) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "servcli")
		...
		customAppTemplate, _ := config.AppConfig(constants.BaseDenom)
